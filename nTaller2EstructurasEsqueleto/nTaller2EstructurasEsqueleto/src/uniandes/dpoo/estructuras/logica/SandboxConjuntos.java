...
public class SandboxConjuntos
{
    ...
    public String getPrimera() {
        return (!arbolCadenas.isEmpty()) ? arbolCadenas.first() : null;
    }
    ...
    public String getUltima() {
        return (!arbolCadenas.isEmpty()) ? arbolCadenas.last() : null;
    }
    ...
    public int getCantidadCadenas() {
        return (arbolCadenas != null) ? arbolCadenas.size() : 0;
    }
    ...
    public boolean compararElementos(String[] otroArreglo) {
        return (arbolCadenas != null && otroArreglo != null)
                ? arbolCadenas.containsAll(List.of(otroArreglo))
                : false;
    }
}
